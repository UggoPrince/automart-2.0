...
export const signup_409 = {
  schema: DuplicateUser,
  status: 409,
  description: 'Duplicate User with same email.',
};

export const login_200 = { schema: CreatedUser, status: 200, description: 'Successful login.' };
export const login_422 = {
  schema: loginFormError,
  status: 422,
  description: 'Invalid form field.',
};
export const login_400 = {
  schema: loginWrongCred,
  status: 400,
  description: 'User does not exist, wrong email or password.',
};
